...
# model.run_svm_model("./clips/23/15.MOV")
#
# load model for evluation
model.load_svm_model(train_features="./data/train_features_v3.npy", train_labels="./data/train_labels_v3.npy", test_features="./data/test_features_v3.npy", test_labels="./data/test_labels_v3.npy")
model.evaluate_svm_model()
