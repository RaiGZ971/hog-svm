...
import useWebSocket from "../hooks/useWebsocketLstm";
...
export default function Recognizer() {
  ...
  const { connect, disconnect, send, lastMessage } = useWebSocket("ws://localhost:8000/ws");
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (data?.prediction) {
        setDetectedGesture(data.prediction);
      }
    } catch (e) {
  ...
  const sendFrame = () => {
    ...
    if (!video || !cameraActiveRef.current || video.videoWidth === 0) return;
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{
                ...
                fontFamily: "'Space Mono', monospace", color: "#1e293b",
            ...
            {VOCAB_CATEGORIES.map((cat) => {
              ...
              return (
                <div key={cat.name}>
                  ...
                  {open && (
                    <div style={{
                      padding: "8px 4px 6px", display: "flex",
